...
//		  }
	...
	public static void addCommentaire(fr.nations.amen.shared.louanges.Commentaire newInput) {
...
PersistenceManager pm = PMF.get().getPersistenceManager();
	...
	public static int getCountMax(String id) {
		...
		Query query = pm.newQuery(CommentEntry.class);
		query.setFilter("gpSouvenir == idParam");
		query.setOrdering("hireDate desc");
		query.declareParameters("Long idParam");
		Object results = query.execute(Long.valueOf(id));
		if (results != null) {
			entries = (List<CommentEntry>) results;
		}
		return entries.size();
	}
}
