...
//	List<CommentEntry> comments = new ArrayList<CommentEntry>();
	...
	public MenuEgliseEntry(String category, String appelation, String description, long date, 
			String albumRefPicasa2, String refYoutube2, String urlpdf) {
