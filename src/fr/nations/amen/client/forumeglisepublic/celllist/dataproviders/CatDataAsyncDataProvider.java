package fr.nations.amen.client.forumeglisepublic.celllist.dataproviders;
 ...
 *
 */
public class CatDataAsyncDataProvider extends AsyncDataProvider<ForumEglise> {
	...
	protected void onRangeChanged(HasData<ForumEglise> display) {
		...
		rpcService.getSouvenirbyCategory(category, range.getStart(), range.getStart()+ UniformDim.PAGE_PUBLIC_SIZE, new AsyncCallback<Vector<ForumEglise>>() {
