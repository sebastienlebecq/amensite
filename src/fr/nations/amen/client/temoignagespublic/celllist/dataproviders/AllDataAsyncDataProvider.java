 ...
 *
 */
public class AllDataAsyncDataProvider extends AsyncDataProvider<Temoignage> {
	...
	protected void onRangeChanged(HasData<Temoignage> display) {
		...
		rpcService.getTemoignagesList(range.getStart(), range.getStart()+ UniformDim.PAGE_PUBLIC_SIZE, new AsyncCallback<Vector<Temoignage>>() {
