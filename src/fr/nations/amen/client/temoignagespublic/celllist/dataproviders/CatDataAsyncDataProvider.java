package fr.nations.amen.client.temoignagespublic.celllist.dataproviders;
 ...
 *
 */
public class CatDataAsyncDataProvider extends AsyncDataProvider<Temoignage> {
	...
	protected void onRangeChanged(HasData<Temoignage> display) {
		...
		rpcService.getTemoignagebyCategory(category, range.getStart(),range.getStart()+ UniformDim.PAGE_PUBLIC_SIZE, new AsyncCallback<Vector<Temoignage>>() {
