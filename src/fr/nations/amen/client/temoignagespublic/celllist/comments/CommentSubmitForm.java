...
public class CommentSubmitForm extends Composite {
	...
	TemoignagesServiceAsync souvenirService = GWT.create(TemoignagesService.class);
  ...
  public CommentSubmitForm(final Temoignage souvenirInfo, final CommentsPanel commentsPanel) {
