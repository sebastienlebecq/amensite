package fr.nations.amen.client.louanges2.treeviewmodel;
...
import fr.nations.amen.client.louanges2.celltypes.custom.PhotoCellWithUiBinder;
import fr.nations.amen.client.louanges2.cellwidget.common.Days;
import fr.nations.amen.client.louanges2.cellwidget.common.Months;
import fr.nations.amen.client.louanges2.cellwidget.common.PsuedoDataSource;
...
public class ListTreeViewModel implements TreeViewModel {
	...
	private void createModel(List<SearchVideo> photos) {
		Iterator<SearchVideo> it = photos.iterator();
		while (it.hasNext()) {
			SearchVideo photo = it.next();
	...
	public ListDataProvider<SearchVideo> getPhotoDataProvider() {
	...
	ListDataProvider<SearchVideo> photoDataProvider;
	...
	public <T> NodeInfo<?> getNodeInfo(T value) {
		if (value==null){
	    	...
	    	photoDataProvider = new ListDataProvider<SearchVideo>(((Days)value).getPhotos());
	    	return new DefaultNodeInfo<SearchVideo>(photoDataProvider, new PhotoCellWithUiBinder());
	    }
	    return null;
	}
	...
	public boolean isLeaf(Object value) {
		return (value instanceof SearchVideo);
	}
}
