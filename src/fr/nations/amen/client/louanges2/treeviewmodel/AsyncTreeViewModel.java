...
import fr.nations.amen.client.louanges2.dataproviders.DayAsyncDataProvider;
import fr.nations.amen.client.louanges2.dataproviders.MonthAsyncDataProvider;
import fr.nations.amen.client.louanges2.dataproviders.PhotoAsyncDataProvider;
import fr.nations.amen.client.louanges2.dataproviders.YearAsyncDataProvider;
...
public class AsyncTreeViewModel implements TreeViewModel {
	...
	AsyncDataProvider<SearchVideo> photoDataAsyncProvider;
	...
	public <T> NodeInfo<?> getNodeInfo(T value) {
		if (value==null){
	    	...
	    	return new DefaultNodeInfo<SearchVideo>(photoDataAsyncProvider, new PhotoCellWithUiBinder());
	    }
	    return null;
	}
