 ...
 *
 */
public class CatDataAsyncDataProvider extends AsyncDataProvider<MessageAudio> {
	...
	protected void onRangeChanged(HasData<MessageAudio> display) {
		...
		rpcService.getSouvenirList(category, range.getStart(),  range.getStart()+ UniformDim.PAGE_PUBLIC_SIZE, new AsyncCallback<Vector<MessageAudio>>() {
