package fr.nations.amen.client.louanges.celllist.dataproviders;
 ...
 *
 */
public class AllDataAsyncDataProvider extends AsyncDataProvider<Louange> {
	...
	protected void onRangeChanged(HasData<Louange> display) {
		...
		//Window.alert("new Range : 
		
		// Call getPhotoList RPC call
		rpcService.getSouvenirAllList(range.getStart(), range.getStart()+ UniformDim.PAGE_ADMIN_SIZE, new AsyncCallback<Vector<Louange>>() {
