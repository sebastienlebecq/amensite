package fr.nations.amen.client.souvenirs.celllist.dataproviders;
 ...
 *
 */
public class AllDataAsyncDataProvider extends AsyncDataProvider<Souvenir> {
	...
	protected void onRangeChanged(HasData<Souvenir> display) {
		...
		rpcService.getSouvenirList(range.getStart(),range.getStart() +UniformDim.PAGE_ADMIN_SIZE, new AsyncCallback<Vector<Souvenir>>() {
