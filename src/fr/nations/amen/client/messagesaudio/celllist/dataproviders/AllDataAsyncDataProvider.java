package fr.nations.amen.client.messagesaudio.celllist.dataproviders;
...
public class AllDataAsyncDataProvider extends AsyncDataProvider<MessageAudio> {
	...
	protected void onRangeChanged(HasData<MessageAudio> display) {
		...
		rpcService.getSouvenirAllList(range.getStart(),  range.getStart()+ UniformDim.PAGE_ADMIN_SIZE, new AsyncCallback<Vector<MessageAudio>>() {
