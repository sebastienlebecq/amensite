...
package fr.nations.amen.client.louangespublic.celllist.comments;
...
public class CommentSubmitForm extends Composite {
	...
	LouangesServiceAsync souvenirService = GWT.create(LouangesService.class);
  ...
  public CommentSubmitForm(final Louange souvenirInfo, final CommentsPanel commentsPanel) {
			...
			AsyncCallback<LoginInfo> acb = new AsyncCallback<LoginInfo>() {
				public void onSuccess(LoginInfo result) {
					...
					if (result != null) {
						...
						Commentaire newInput = new Commentaire(souvenirInfo.getId(), auteur,
								comment, new Date().getTime(), souvenirInfo.getSujet());
...
/*      	  
        ...
        }//end  void submitComment(String comment)
      });
