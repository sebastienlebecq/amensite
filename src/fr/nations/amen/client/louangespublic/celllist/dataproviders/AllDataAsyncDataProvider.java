package fr.nations.amen.client.louangespublic.celllist.dataproviders;
...
public class AllDataAsyncDataProvider extends AsyncDataProvider<Louange> {
	...
	protected void onRangeChanged(HasData<Louange> display) {
		...
		rpcService.getLouangeByCategory("cat0", range.getStart(), range.getLength(), new AsyncCallback<Vector<Louange>>() {
