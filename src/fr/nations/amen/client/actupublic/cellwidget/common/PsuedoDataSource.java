...
public class PsuedoDataSource {
	...
	public static List<Actu> createData(int dataSize) {
		if (instance == null)
	...
	public static List<Actu> createData() {
		if (instance == null)
			instance = new PsuedoDataSource();
		Actu[] thePhotos = new Actu[instance.DATA_SIZE];
		for (int i = 0; i < instance.DATA_SIZE; i++) {
			Actu photo = new Actu(""+idCounter++);
	...
	public static void populate(final List<Actu> theList, final ListDataProvider<Actu> dataListProvider){
