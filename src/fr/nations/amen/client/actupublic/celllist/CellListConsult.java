...
import fr.nations.amen.client.actupublic.celllist.celltypes.custom.ActuCellWithUiBinder;
 ...
 *
 */
public class CellListConsult extends Composite {

	interface CellTypesUiBinder extends UiBinder<Widget, CellListConsult> {
	}
...
//	PageSizePager pagerShowMore;
	...
	public CellListConsult() {
		actuList = new CellList<Actu>(new ActuCellWithUiBinder());
	...
	private void applyOptions() {
		actuList.setPageSize(UniformDim.PAGE_PUBLIC_SIZE);
	}
...
//						}
						 actuForm.setActu(selectionModel.getSelectedObject());
					}
				});
	}
}
