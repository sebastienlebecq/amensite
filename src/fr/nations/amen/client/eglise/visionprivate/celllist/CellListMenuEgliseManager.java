...
import fr.nations.amen.client.eglise.visionprivate.celllist.celltypes.custom.SouvenirCellWithUiBinder;
import fr.nations.amen.client.eglise.visionprivate.celllist.dataproviders.AllDataAsyncDataProvider;
 ...
 *
 */
public class CellListMenuEgliseManager extends Composite {
	
	MenuEgliseServiceAsync egliseService = GWT.create(MenuEgliseService.class);

	interface CellTypesUiBinder extends UiBinder<Widget, CellListMenuEgliseManager> {
	}
	...
	CellList<MenuEglise> souvenirList;
		  @UiField
	  MenuEgliseManagerForm souvenirManagerForm;
	  
	public CellListMenuEgliseManager() {
		
		souvenirList = new CellList<MenuEglise>(new SouvenirCellWithUiBinder());
...
//	}
	...
	private void handleUpdates() {
		souvenirList.setValueUpdater(new ValueUpdater<MenuEglise>() {
			@Override
			public void update(MenuEglise value) {
	...
	private void setUpSelectionModel() {
		final SingleSelectionModel<MenuEglise> selectionModel = new SingleSelectionModel<MenuEglise>();
