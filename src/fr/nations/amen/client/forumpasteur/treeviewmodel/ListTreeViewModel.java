...
import fr.nations.amen.client.forumpasteur.cellwidget.common.Days;
import fr.nations.amen.client.forumpasteur.cellwidget.common.Months;
import fr.nations.amen.client.forumpasteur.cellwidget.common.PsuedoDataSource;
import fr.nations.amen.client.forumpasteur.cellwidget.common.Years;
import fr.nations.amen.shared.forumpasteur.Messages;

public class ListTreeViewModel implements TreeViewModel {
	
	
	private void createModel(List<Messages> photos) {
		Iterator<Messages> it = photos.iterator();
		while (it.hasNext()) {
			Messages photo = it.next();
	...
	public ListDataProvider<Messages> getPhotoDataProvider() {
	...
	ListDataProvider<Messages> photoDataProvider;
	...
	public <T> NodeInfo<?> getNodeInfo(T value) {
		if (value==null){
	    	...
	    	photoDataProvider = new ListDataProvider<Messages>(((Days)value).getPhotos());
	    	return new DefaultNodeInfo<Messages>(photoDataProvider, new PhotoCellWithUiBinder());
	    }
	    return null;
	}
