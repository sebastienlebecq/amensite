 ...
 */
@RemoteServiceRelativePath("servicefp")
public interface ForumPasteurService extends RemoteService
{
	/**
	 ...
	 * @return
	 */
	List<Messages> getPhotoByDateList(int year, int month, int day, int rangeStart, int rangeLength);
	 ...
	 */
	Messages getPhotoDetails(String id) throws PhotoNotFoundException;
	 ...
	 * @return
	 */
	Vector<Messages> getPhotoList(int rangeStart, int rangeLength);
	 ...
	 * @return
	 */
	Vector<Messages> getPhotoList(int rangeStart, int rangeLength, String sortOn, boolean isAscending);
	 ...
	 * @return
	 */
	Messages updatePhotoDetails(Messages photoDetails);
}